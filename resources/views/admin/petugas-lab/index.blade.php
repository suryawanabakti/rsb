...
@section('title', 'Data Petugas Lab')

@section('content')
    <div class="mb-8 flex justify-between items-end">
        <div>
            <h1 class="text-2xl font-bold text-slate-900">Data Petugas Lab</h1>
            <p class="text-slate-500">Kelola informasi petugas laboratorium</p>
        </div>
        <a href="{{ route('admin.petugas-labs.create') }}"
            class="bg-emerald-600 text-white px-6 py-2 rounded-xl font-bold text-sm hover:bg-emerald-700 transition-colors flex items-center">
            <span class="mr-2">➕</span> Tambah Petugas
        </a>
    </div>
