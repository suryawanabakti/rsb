...
<head>
    ...
    <title>Verifikasi SKBJ - RS. Bhayangkara Makassar</title>
    <script src="https://unpkg.com/@tailwindcss/browser@4"></script>
    <style>
        @import url('https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@400;500;600;700;800&display=swap');
        body { font-family: 'Plus Jakarta Sans', sans-serif; }
        .glass { background: rgba(255, 255, 255, 0.85); backdrop-filter: blur(12px); }
        .hero-gradient { background: linear-gradient(135deg, #fef9f0 0%, #fef3e2 50%, #fff7ed 100%); }
    </style>
</head>
        ...
        <div class="glass rounded-3xl shadow-2xl border border-white/50 overflow-hidden">
            ...
            <div class="p-8 space-y-6">
                ...
                <div>
                    <div class="flex items-center justify-between mb-4">
                        <div>
                            ...
                            <p class="text-lg font-extrabold text-slate-900">SURAT KETERANGAN BERBADAN SEHAT / JASMANI</p>
                        </div>
                        <span class="px-4 py-1.5 bg-amber-100 text-amber-700 rounded-full text-xs font-extrabold uppercase tracking-wider">SKBJ</span>
                    </div>
                    <p class="text-sm text-slate-600">
                        <span class="font-bold text-slate-700">Nomor:</span>
                        {{ $letterRequest->nomor_surat ?? ('SKBJ/' . $letterRequest->id . '/' . now()->format('m/Y') . '/Rumkit') }}
                    </p>
                </div>
                ...
                <div class="bg-emerald-50 rounded-2xl p-5 border border-emerald-100 text-center">
                    ...
                    <p class="text-lg font-extrabold text-emerald-700 mt-1">BERBADAN SEHAT</p>
                </div>
