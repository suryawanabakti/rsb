...
<head>
    ...
    <title>Layanan Digital RS. Bhayangkara</title>
    ...
    <div
        ...
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            ...
            <div
                ...
                <img src="{{ asset('images/logo.png') }}" alt="Logo" class="w-48 h-48 mx-auto mb-6">
                <h1 class="text-4xl font-black text-blue-900 text-center mb-2 uppercase">RS. BHAYANGKARA MAKASSAR</h1>
                <p class="text-blue-600 font-bold text-center tracking-widest uppercase">Layanan Administrasi Surat
                    Digital</p>
